...
if(isset($_POST["operation"]))
{
	if($_POST["operation"] == "Add")
	{
		...
		$statement = $connection->prepare("
			INSERT INTO users (carnet, first_name, last_name, trabajograduacion, egreso, image, graduacion) 
			VALUES (:carnet, :first_name, :last_name, :trabajograduacion, :image, :egreso, :graduacion)
		");
